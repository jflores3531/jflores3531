...
- **Verify-before-commit safety** on lockout-prone changes — the vty ACL script opens a *second independent SSH session* to prove logins still work before trusting the change, and reverts through the still-open primary session if they don't
